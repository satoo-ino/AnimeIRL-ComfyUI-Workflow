...
> Drop a drawing into a photograph and let FLUX.2 Klein decide what the light does.
...
|---|---|---|
| ![input](images/drawing.png) | ![input](images/photo.png) | ![normal dithering](images/output.png) |
