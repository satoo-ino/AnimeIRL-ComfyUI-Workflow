...
| Input 1 | Input 2 | Starting latent | Flux.2 Klein output |
|---|---|---|---|
| ![input](examples/drawing.jpg) | ![input](examples/photo.png) | ![input](examples/latent.png) | ![normal dithering](examples/output.png) |
 > - The `starting latent` is made by the workflow itself — combining Input1 and Input2 using a mask generated by SAM3
